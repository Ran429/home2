...
import BoardListDownloadButton from "./board-list-dowload-button";
          ...
          items.map((item, i) => (
            <TableRow key={i} className={cn("*:border *:border-[#EEEEEE]")}>
              ...
              <TableCell className="text-center">
                {item.files && (
                  <BoardListDownloadButton
                    files={item.files as UploadFile[]}
                    fileName={item.title.replaceAll(" ", "_") + ".zip"}
                  />
                )}
              </TableCell>
              <TableCell className="text-center">
